...
public class Coordinates {
    ...
    public Coordinates newPosition(Coordinates targetPosition, ArrayList<Hero> team) {
    ...
    public boolean containsByPos(Coordinates nextPosition, ArrayList<Hero> team) {
        for (Hero hero: team) {
            if (hero.coordinates == nextPosition) return true;
        }
        return false;
    }
}